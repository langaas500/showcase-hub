...
const brand = "MYSEN SNEKKERSERVICE ENK";
const tagline = "Tømrer i Mysen og Indre Østfold";
const phone = "123 45 678";
const email = "post@dinhandverker.no";

const area = "Mysen, Askim, Trøgstad og omegn";
const openingHours = "Man–fre 08–16";
...
function IconPaintRoller(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
      <path d="M18,15.5V11c0-.5-1-1-1-1H13V8h2c1.1,0,2-.9,2-2V4c0-1.1-.9-2-2-2H9C7.9,2,7,2.9,7,4v2c0,1.1.9,2,2,2h2v2H7c0,0-1,.5-1,1v4.5c0,.5.5,1.5,1,1.5v5c0,1.1.9,2,2,2h1c1.1,0,2-.9,2-2v-5h2v5c0,1.1.9,2,2,2h1c1.1,0,2-.9,2-2v-5C17.5,17,18,16,18,15.5z" />
    </svg>
  );
}
...
function SectionTitle({
  ...
  return (
    <div className="max-w-3xl">
      {kicker ? (
        <p className="text-orange-500 font-semibold tracking-widest uppercase text-sm flex items-center gap-2">
...
export default function HaandverkerPage() {
  const [mobileOpen, setMobileOpen] = React.useState(false);

  const navLinkBase =
    "text-white/90 hover:text-orange-400 transition-colors text-sm font-semibold";
  const navLinkActive =
    "text-white border-b-2 border-orange-500 pb-1 hover:text-orange-400 transition-colors text-sm font-semibold";
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="bg-gray-900 sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a
              href={telHref}
              className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 rounded font-bold transition-colors"
            >
              Ring nå: {phone}
            </a>
          </nav>
        ...
        {mobileOpen ? (
          <div className="md:hidden border-t border-white/10">
            <div className="container mx-auto px-4 py-4 flex flex-col gap-3">
              ...
              <a
                href={telHref}
                className="mt-2 inline-flex items-center justify-center bg-orange-500 hover:bg-orange-600 text-white font-bold px-6 py-3 rounded transition-colors"
              >
                Ring nå: {phone}
              </a>
            </div>
        ...
        <div className="container mx-auto px-4 py-16 md:py-24">
          <div className="grid md:grid-cols-2 gap-10 md:gap-12 items-center">
            ...
            <div className="text-white">
              <p className="text-orange-400 font-semibold mb-4 flex items-center gap-2 tracking-widest uppercase text-sm">
                <IconDot className="w-3 h-3" />
                {tagline}
              </p>

              <h1 className="text-4xl md:text-6xl lg:text-7xl font-black mb-5 leading-tight">
                TØMRER I <span className="text-orange-500">MYSEN</span>
              </h1>

              <p className="text-xl md:text-2xl font-semibold text-white/90 mb-6">
                Terrasse &bull; Vinduer/dører &bull; Oppussing &bull; Småjobber
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
                <a
                  href={telHref}
                  className="inline-flex items-center justify-center bg-orange-500 hover:bg-orange-600 text-white text-lg font-black px-8 py-4 rounded transition-colors"
                >
                  Ring nå: {phone}
                </a>
                <a
      ...
      <section id="tjenester" className="py-16 bg-stone-100">
        <div className="container mx-auto px-4">
          <SectionTitle
            ...
            subtitle="Folk ringer ikke for &quot;håndverk&quot;. De ringer for en jobb som må bli gjort. Her er de vanligste."
          />

          <div className="mt-10 grid md:grid-cols-3 gap-8">
            <div className="bg-white rounded-xl p-7 shadow-sm border border-gray-200">
              <div className="flex items-center gap-3">
                <IconHammer className="w-10 h-10 text-gray-900" />
                <h3 className="text-xl font-black text-gray-900">Terrasse &amp; platting</h3>
              </div>
              <p className="mt-3 text-gray-600">
                Bygging og reparasjon av terrasse, platting og uteområder. Rette fall, solid fundament, pent resultat.
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-7 shadow-sm border border-gray-200">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-xl font-black text-gray-900">Vinduer &amp; dører</h3>
              </div>
              <p className="mt-3 text-gray-600">
                Utskifting og tetting. Mindre trekk, bedre varmeøkonomi og skikkelig finish.
              </p>
            </div>

            <div className="bg-white rounded-xl p-7 shadow-sm border border-gray-200">
              <div className="flex items-center gap-3">
                <IconPaintRoller className="w-10 h-10 text-gray-900" />
                <h3 className="text-xl font-black text-gray-900">Oppussing inne</h3>
              </div>
              <p className="mt-3 text-gray-600">
                Vegger, tak, gulv, lister og små ombygginger. Ryddig arbeid og tydelig avtale.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 bg-gray-900 rounded-xl p-7 md:p-10 text-white flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              ...
              <p className="mt-2 text-white/80">
                De jobbene de store ikke tar. Vi tar dem, og svarer når du ringer.
              </p>
            </div>
            <a
              href={telHref}
              className="inline-flex items-center justify-center bg-orange-500 hover:bg-orange-600 text-white font-black px-8 py-4 rounded transition-colors"
            >
              Ring nå: {phone}
            </a>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mt-10 grid md:grid-cols-3 gap-8">
            {[
              {
                quote:
                  "Rask respons og ryddig arbeid. Kom som avtalt og prisen stemte.",
                who: "Privatkunde i Mysen",
              },
              {
                quote:
                  "Veldig fornøyd med resultatet. God kommunikasjon hele veien.",
                who: "Kunde i Indre Østfold",
              },
              {
                quote:
                  "Tok en liten jobb andre ikke ville ha. Effektiv og profesjonell.",
      ...
      <section id="om-oss" className="py-18 md:py-20 bg-gray-900 text-white">
        <div className="container mx-auto px-4 py-16 md:py-20">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <p className="text-orange-400 font-semibold tracking-widest uppercase text-sm flex items-center gap-2">
                <IconDot className="w-3 h-3" />
                Om oss
              </p>
              <h2 className="mt-3 text-3xl md:text-5xl font-black">Lokalt og pålitelig</h2>
              <div className="mt-6 w-20 h-1 bg-orange-500" />

              <p className="mt-7 text-lg text-white/80 leading-relaxed">
                Vi er et lokalt enkeltmannsforetak som tar oppdrag i{" "}
              ...
              <ul className="mt-7 space-y-3 text-white/85">
                {[
                  ...
                  <li key={x} className="flex items-start gap-3">
                    <IconCheck className="w-6 h-6 text-orange-400 mt-0.5" />
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 max-w-3xl space-y-4">
            {[
              {
                q: "Tar dere små jobber?",
                a: "Ja. Småjobber er velkomne. Det er ofte de som må løses raskt.",
              },
              {
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3">
                <a
                  href={telHref}
                  className="inline-flex items-center justify-center bg-orange-500 hover:bg-orange-600 text-white font-black px-8 py-4 rounded transition-colors text-lg"
                >
                  {phone}
                </a>
                <a
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="text-center">
              <a href={mailHref} className="text-gray-300 hover:text-orange-500 text-sm transition-colors">
                {email}
              </a>
              <p className="text-gray-500 text-xs mt-1">
                {brand} &bull; Org.nr {orgnr} &bull; {area}
              </p>
            </div>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 z-50">
        <div className="bg-gray-900/95 backdrop-blur border-t border-white/10 px-4 py-3">
          <a
            href={telHref}
            className="w-full inline-flex items-center justify-center bg-orange-500 hover:bg-orange-600 text-white font-black py-4 rounded-lg text-lg"
          >
            Ring nå: {phone}
          </a>
        </div>
